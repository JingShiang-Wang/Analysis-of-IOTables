...
$$ i產業的感應度\  \triangleq\ \frac{\displaystyle\sum^n_{j=1} x_{ij}}{\frac{1}{n}\displaystyle\sum^n_{i=1}\displaystyle\sum^n_{j=1}x_{ij}}$$ 

$$ i產業的影響度\  \triangleq\ \frac{\displaystyle\sum^n_{i=1} x_{ij}}{\frac{1}{n}\displaystyle\sum^n_{i=1}\displaystyle\sum^n_{j=1}x_{ij}}$$
